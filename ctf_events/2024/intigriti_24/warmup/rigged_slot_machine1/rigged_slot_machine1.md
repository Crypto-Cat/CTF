...
Someone actually found a nice unintended that works on both Rigged slot 1 _and_ 2. I'll not spoil it yet, so they have an opportunity to create a writeup!
